...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../src/core/BetManager.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function BetManager(deposit, baseBet) {
    this.deposit = deposit;
    this.baseBet = baseBet || 0;
    this.currentBet = this.baseBet;
  }

  BetManager.prototype.getDeposit = function () {
    return this.deposit;
  };
  ...
  BetManager.prototype.getBaseBet = function () {
    return this.baseBet;
  };
  ...
  BetManager.prototype.roundWon = function () {
    this.deposit += this.currentBet;
    return this.resetBet();
  };

  BetManager.prototype.roundLost = function () {
    this.deposit -= this.currentBet;
    this.currentBet *= 2;
    return this.currentBet;
  };
...
function (_super) {
  ...
  App.prototype.handleWon = function (event) {
    this.betManager.roundWon();
    this.update();
  };

  App.prototype.handleLost = function () {
...
react_dom_1.render(react_1.createElement(app_1["default"]), document.getElementById("root"));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","../src/components/app":"../src/components/app.tsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/src.9caef6c7.map